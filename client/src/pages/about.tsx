  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-10">
      ...
      <div style={{ background: "linear-gradient(135deg, #F59E0B 0%, #D97706 100%)" }} className="px-4 py-4 flex items-center gap-3">
        <button onClick={() => window.history.back()} data-testid="button-back-about" className="text-white">
      ...
      <div className="px-4 py-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div key={item.label} className="bg-white rounded-2xl p-3 shadow-sm border border-gray-100 flex flex-col items-center text-center">
        ...
        <div className="rounded-2xl overflow-hidden shadow-sm bg-white p-6 text-center border border-gray-100">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            {[
              { date: "Août 2023", text: "SINOPEC lance sa première série de plans VIP pour accompagner l'expansion de la plateforme." },
              { date: "Novembre 2023", text: "La plateforme améliore son espace utilisateur, son support client et ses parcours de dépôt et retrait." },
              { date: "Mai 2024", text: "De nouveaux plans VIP sont ajoutés pour répondre à différents niveaux d'investissement." },
              { date: "Avril 2025", text: "SINOPEC renforce son système de parrainage avec des commissions multi-niveaux." },
              { date: "Juillet 2025", text: "Clara, l'assistante IA, accompagne désormais les membres sur les principales questions de la plateforme." },
            ].map((item, i) => (
              <div key={i} className="flex gap-3">
                <div className="flex flex-col items-center">
                  <div className="w-3 h-3 rounded-full bg-amber-400 flex-shrink-0 mt-1" />
                  {i < 4 && <div className="w-0.5 bg-gray-100 flex-1 mt-1" />}
                </div>
                <div className="pb-2">
                  <p className="text-amber-500 font-bold text-xs mb-1">{item.date}</p>
        ...
        <div className="rounded-2xl p-4 shadow-sm border border-amber-100" style={{ background: "linear-gradient(135deg, #F59E0B, #D97706)" }}>
